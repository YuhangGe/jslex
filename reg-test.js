var res = new Array();
 ...
 res[255] = /ab.cd/i;
 res[256] = /a(b)c/i;
 res[257] = /Inthisnexttest,Jisnotsetattheouterlevel;
consequentlyitisn'tsetinthepattern'soptions;
consequentlypcre_get_named_substring()producesarandomvalue./i;
 res[258] = /\777/i;
 res[259] = /\s*,\s*/i;
 res[260] = /^abc/im;
 res[261] = /abc$/im;
...
:".\\\[\]\000-\037\x80-\xff])|\[(?:[^\\\x80-\xff\n\015\[\]]|\\[^\x80-\xff])*\])[\040\t]*(?:\([^\\\x80-\xff\n\015()]*(?:(?:\\[^\x80-\xff]|\([^\\\x80-\xff\n\015()]*(?:\\[^\x80-\xff][^\\\x80-\xff\n\015()]*)*\))[^\\\x80-\xff\n\015()]*)*\)[\040\t]*)*)*>)/;
 ...
 res[1008] = /([^a]*?)*/;
 res[1009] = /([^ab]*?)*/;
 res[1010] = /The following tests are taken from the Perl 5.005 test suite;
 some of them/;
...
", 288);
 ...
 // We are compatible with JSC, and don't throw an exception in this case. // assertThrows("var re = /(){2,4294967295}/;
", 467);
...
", 2438);
 assertNull(res[808].exec("\x01\x01e;
z", 2439));
